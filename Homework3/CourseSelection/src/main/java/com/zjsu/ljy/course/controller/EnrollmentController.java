...
public class EnrollmentController {
     ...
     */
    @PostMapping
    public ResponseEntity<ApiResponse<Enrollment>> enrollCourse(@RequestBody EnrollmentCreateRequest request) {
        Enrollment enrollment = enrollmentService.enrollCourse(
                request.getCourseId(),
